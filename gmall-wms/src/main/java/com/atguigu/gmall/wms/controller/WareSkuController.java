...
public class WareSkuController {
    ...
    @GetMapping("{skuId}")
    public Resp<List<WareSkuEntity>> queryWareSkuById(@PathVariable(value = "skuId")Long skuId){
        List<WareSkuEntity> wareSkuEntities = wareSkuService.queryWareSkuById(skuId);
