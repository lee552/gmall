...
public class AttrAttrgroupRelationController {
    ...
    public Resp<Object> deleteAttrGroupRelationById(@RequestBody List<AttrAttrgroupRelationEntity> list){

        attrAttrgroupRelationService.deleteAttrGroupRelationById(list);
        return Resp.ok(null);
    }
